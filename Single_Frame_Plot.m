function Single_Frame_Plot(q_array_i)
...
link_plot_2points('AB',r_vec,'r');
link_plot_2points('AG',r_vec,'r');
link_plot_2points('GB',r_vec,'r');
link_plot_2points('GH',r_vec,'r');
link_plot_2points('HI',r_vec,'r');
link_plot_2points('IK',r_vec,'l');
link_plot_2points('KJ',r_vec,'l');
link_plot_2points('JC',r_vec,'l');
link_plot_2points('JD',r_vec,'l');
link_plot_2points('CD',r_vec,'l');
link_plot_2points('IT',r_vec,'m');
link_plot_2points('LN',r_vec,'l');
link_plot_2points('NF',r_vec,'l');
link_plot_2points('LM',r_vec,'r');
link_plot_2points('ME',r_vec,'r');
...
for i = 1:14
    ...
    plot(r_Point_Plot(1),r_Point_Plot(2),'o','MarkerSize',MarkSize_Coef,...
...
function link_plot_2points(Edges,r_vec,side)
...
if nargin<3
    plot([Edge1(1),Edge2(1)]',[Edge1(2),Edge2(2)]','LineWidth',Linewidth_Coef, 'color', left_color);
    hold on
else
    if side =='l'
        plot([Edge1(1),Edge2(1)]',[Edge1(2),Edge2(2)]','LineWidth',Linewidth_Coef, 'color', left_color);
        ...
        if side == 'r'
            plot([Edge1(1),Edge2(1)]',[Edge1(2),Edge2(2)]','LineWidth',Linewidth_Coef, 'color', rght_color);
        else
             plot([Edge1(1),Edge2(1)]',[Edge1(2),Edge2(2)]','LineWidth',Linewidth_Coef, 'color', midl_color);       
        end
    end
end
hold on
